    ...
    <div ref={containerRef} className="min-h-screen w-screen relative bg-black">
      ...
      <div className="relative mx-auto">
        ...
        <div
          ref={phoneRef}
          id="phone"
          className="min-h-screen flex flex-col justify-center items-center bg-yellow-100f"
        >
        ...
        <div className="relative z-10 w-[100vw] lg:w-[80vw] mx-auto">
...
"
      ...
      {/* Next Section */}
      <div className="h-screen bg-blue-400 flex items-center justify-center mt-96">
        <h2 className="text-2xl font-bold text-white">Next Section</h2>
      </div>
    </div>
  );
};
