...
export const ScreenOne = () => {
  return (
    <div className="">
      <div className="rounded-[40px] p-6 flex flex-col gap-4 items-center bg-mutedELight    m-2 mx-auto w-full h-[98%] overflow-y-hidden relative">
      ...
      <div className="absolute bg-mutedELight border-2 border-white/15 rounded-br-[2.7em] rounded-bl-[2.7em] w-[100%] bottom-0 p-6 flex justify-between gap-4 backdrop-blur text-white/70 left-0">
